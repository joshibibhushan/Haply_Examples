class Defender{
  ...
  /* defendObject1.setPosition(20,5);
    defendObject1.setFill(200,0,0);
     defendObject1.setNoStroke();
 
      defendObject1.setStaticBody(true);
        defendObject1.setSensor(true);
            defendObject1.setDensity(12);
      world.add(defendObject1);*/
